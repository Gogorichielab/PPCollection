...
(async () => {
  ...
  console.log('Going directly to firearm details page (ID: 1)...');
  await page.goto('http://localhost:3000/firearms/1/details');
  ...
  const modalBeforeClick = page.locator('#delete-modal');
  ...
  const dialogElement = page.locator('.modal-dialog');
